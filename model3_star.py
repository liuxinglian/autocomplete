...
def build_nn(n_layers, xpu, cell_type, training, stars, input_ph, n_steps, n_inputs, n_neurons, seq_length_ph, out_size=100, keep_prob=0.5, bidirection=False):
...
def main():
    ...
    nn_model = build_nn(n_layers, cpu_or_gpu, cell_ty, training, stars_ph, input_ph, n_steps, n_inputs, n_neurons, seq_length_ph, bidirection=if_bidirect)
